    ...
    const handleCreateGroup = async () => {
        ...
        try {
            const newGroupData = {
                ...
                description: newGroupDescription.trim() || 'No description provided.', // Added Description
                pictureUrl: newGroupPictureUrl.trim() || 'https://placehold.co/100x100/A5B4FC/3730A3?text=STRIDE', // Added Picture URL
                creatorId: user.uid,
